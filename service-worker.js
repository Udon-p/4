...
const staticCacheName = 'site-static-v113'; // เปลี่ยน v2 เป็น v3 เพื่อบังคับอัปเดต
const dynamicCacheName = 'site-dynamic-v112'; // Cache สำหรับไฟล์ที่เปลี่ยนแปลงบ่อย หรือมาจากข้างนอก
